...
$env:COSIGN_YES = "true"
$env:GITSIGN_FULCIO_URL = $FULCIO_URL
$env:GITSIGN_REKOR_URL = $REKOR_URL
...
Write-Output "GITSIGN_FULCIO_URL=$env:GITSIGN_FULCIO_URL"
Write-Output "GITSIGN_REKOR_URL=$env:GITSIGN_REKOR_URL"
